...
import { ChartTooltipContent } from "@getbud-co/buds";
...
const gaugeCode = `import { Chart } from "@getbud-co/buds";
...
const halfGaugeCode = `import { Chart } from "@getbud-co/buds";
...
const gaugeSizesCode = `import { Chart } from "@getbud-co/buds";
...
const heatmapCode = `import { Heatmap } from "@getbud-co/buds";
...
const sparklineCode = `import { Sparkline } from "@getbud-co/buds";
...
const radarCode = `import { Radar } from "@getbud-co/buds";
...
const funnelCode = `import { Funnel } from "@getbud-co/buds";
...
export function Charts() {
  ...
  return (
    <DocSection
      id="charts"
      title="Charts"
      description="Gráficos para visualização de dados, construídos com Recharts e estilizados com os tokens do BUDS. Inclui gráficos de barras, linhas, áreas, pizza e indicador circular de progresso."
